        ...
        // </>
            <div className="bg-white py-8 sm:py-8 lg:py-12">
                <div className="max-w-screen-2xl px-4 md:px-20 mx-auto">
                    ...
                    <form className="max-w-screen-md grid sm:grid-cols-2 gap-4 mx-auto" onSubmit={onSubmit}>
                        <div>
                            <label htmlFor="first-name" className="inline-block text-blue-800 text-sm sm:text-base mb-2">姓</label>
                            <input name="first-name" className="w-full bg-gray-50 text-blue-800 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2" />
                        </div>

                        <div>
                            <label htmlFor="last-name" className="inline-block text-blue-800 text-sm sm:text-base mb-2">名</label>
                            <input name="last-name" className="w-full bg-gray-50 text-blue-800 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2" />
                        </div>

                        <div className="sm:col-span-2">
                            <label htmlFor="accountName" className="inline-block text-blue-800 text-sm sm:text-base mb-2">アカウント名</label>
                            <input name="accountName" className="w-full bg-gray-50 text-blue-800 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2" />
                        </div>
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <div className="flex items-center mb-4">
                                ...
                                <label htmlFor="default-radio-1" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">lady</label>
                            </div>
                        <div className="flex items-center">
                            <input checked id="default-radio-2" type="radio" value="" name="default-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                            <label htmlFor="default-radio-2" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">man</label>
                        </div>
                        </div>
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <input type="password" name="passwrod" className="w-full bg-gray-50 text-blue-800 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2" />
                        </div>

                        <div className="sm:col-span-2">
                            <label htmlFor="message" className="inline-block text-blue-800 text-sm sm:text-base mb-2">備考</label>
                            <textarea name="message" className="w-full bg-gray-50 text-blue-800 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2"></textarea>
                        </div>
