...
export const Login : FC = () => {
    ...
    return (
        <>
            {
                Header([{label: "登録", url: "/top/register"}])
            }
            <div className="bg-white py-6 sm:py-8 lg:py-12">
                <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
                    ...
                    <div className="flex flex-col gap-4 p-4 md:p-8">
                        ...
                        <div>
                        <label form="email" className="inline-block text-gray-800 text-sm sm:text-base mb-2">アカウント名</label>
                        ...
                        <div>
                        <label form="password" className="inline-block text-gray-800 text-sm sm:text-base mb-2">パスワード</label>
                        ...
                        <button type="submit"  className="block bg-gray-800 hover:bg-gray-700 active:bg-gray-600 focus-visible:ring ring-gray-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">ログイン</button>
